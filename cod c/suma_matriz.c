...
void sumar_matriz (float [][NC],float[][NC],float[][NC],int,int); //prototipo
...
void sumar_matriz (float X[][NC],float Y[][NC],float Z[][NC],int nc,int nf){
    int i,j;
            for ( i = 1; i < nf; i++)
            {
                for ( j = 1; j < nc; j++)
