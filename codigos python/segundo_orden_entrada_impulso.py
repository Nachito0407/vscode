...
# Ecuación diferencial segundo orden con entrada impulso como pulso corto
def sistema(y, t, zeta, omega_n):
    u = 1e3 if (0 <= t <= 0.001) else 0  # impulso unitario aproximado
    dy1dt = y[1]
...
ax.set_title('Respuesta sistema 2º orden ante impulso unitario\nCondiciones iniciales nulas')
ax.grid(True)
